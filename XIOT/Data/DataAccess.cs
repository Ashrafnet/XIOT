...
namespace XIOT.Data
{
	public class SessionStateMonitor
    {
        ...
        private static ManualResetEventSlim _monitorResetEvent = new ManualResetEventSlim(false);
        ...
        {
            while (!(_monitorResetEvent.Wait(60000)))
            	try
                {
    ...
    public partial class SqlStatement : IDisposable
    {
        ...
        public static DbCommand CreateCommand(DbConnection connection)
        {
            ...
            if (t.FullName.StartsWith("Oracle.DataAccess"))
