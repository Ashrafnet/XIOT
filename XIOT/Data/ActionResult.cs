...
namespace XIOT.Data
{
	public class ActionResult
    {
        ...
        {
            ExecuteOnClient("this._focus(\'{0}\',\'{1}\');", fieldName, BusinessRules.JavaScriptString(message));
        }
        ...
        {
            ExecuteOnClient("Web.DataView.showModal(null, \'{0}\', \'{1}\', \'{2}\', \'{3}\');", controller, view, startCommandName, startCommandArgument);
        }
        ...
        {
            ExecuteOnClient("this.refresh({0});", (!(fetch)).ToString().ToLower());
        }
        ...
        {
            ExecuteOnClient("this._forceChanged=true;this._raiseDelayedLoading=true;");
        }
